...
class ConnectionManager:
    ...
    async def connect(self, user_id: UUID, websocket: WebSocket, squad_id: Optional[UUID] = None) -> None:
    ...
    def disconnect(self, user_id: UUID, squad_id: Optional[UUID] = None) -> None:
    ...
    async def broadcast_to_squad(self, message: dict, squad_id: UUID, exclude_user: Optional[UUID] = None) -> None:
